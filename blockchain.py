...
def get_balance(participant):
    ...
    # spend coins before the transaction was confirmed + included in a block
...
def mine_block():
    ...
    # This ensures that if for some reason the mining should fail, we don't have the
    # reward transaction stored in the open transactions
...
while waiting_for_input:
    ...
    if not verify_chain():
        ...
        break
    print('Balance of {}: {:6.2f}'.format('Bart', get_balance('Bart')))
else:
    print('User left!')
